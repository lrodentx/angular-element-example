import { Component, OnInit, ViewEncapsulation, Input, Output, EventEmitter, AfterViewInit, OnChanges } from '@angular/core';
...
export class ButtonComponent implements AfterViewChecked, AfterViewInit, OnInit {

  @Input() config: any = {};

  @Input() widgetModel: any = {};
  @Input() wert1: String;
  @Input() wert2: String;
  ...
  @Output() registerAttributeEvent: EventEmitter<any> = new EventEmitter<any>();


  @Output() valueChange: EventEmitter<any> = new EventEmitter<any>();
  @Output() fireEvent: EventEmitter<any> = new EventEmitter<any>();
  ...
  private createAttributeEvents(): void {
